...
license: MIT
compatibility: Requires Node.js 18+. Designed for Codex or similar coding agents.
metadata:
  author: posthog
  version: "0.3"
  domain: cli-tui
...
Ink is the dominant Node.js TUI framework — used by Codex (Anthropic), Gemini CLI
