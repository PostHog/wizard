...
/** Boolean flag: on → pi for self-driving. Payload carries `{model, effort}` (wizard-pi-model variant key + effort level); missing/invalid payload keeps the non-flagged default. */
