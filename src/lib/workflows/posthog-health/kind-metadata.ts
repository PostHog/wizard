...
const DOCS_BASE = 'https://posthog.com';
...
export const KIND_METADATA: Record<string, KindMeta> = {
  ingestion_lag: {
    ...
    docsUrl: `${DOCS_BASE}/docs/support/troubleshooting`,
  },
  ingestion_warning: {
  ...
  materialized_view_failure: {
    ...
    docsUrl: `${DOCS_BASE}/docs/data-warehouse`,
  },
  external_data_failure: {
    ...
    docsUrl: `${DOCS_BASE}/docs/data-warehouse/sources`,
  },
};
