/**
 * Learn-pane script for the posthog-integration workflow.
 *
 * Composes the per-diagram blocks from this directory into the timed
 * narrative that runs in the left "Learn" pane of RunScreen.
 */
...
import { DATA_FLOW_BLOCK } from './data-flow.js';
...
export const getContentBlocks = (store?: WizardStore): ContentBlock[] => [
  ...
  { content: 'It takes about eight minutes.', pause: 2000 },

  { content: 'So grab some coffee ☕️.', pause: 2000 },

  { content: 'Or stick around and learn about PostHog.', pause: 5000 },
