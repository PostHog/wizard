...
const WIZARD_COMMANDMENTS = [
  ...
  'Use the TodoWrite tool to track your progress. Create a todo list at the start with all major tasks, mark each as in_progress when you begin it, and completed when done.',
].join('\n');
