...
/**
 * Discriminated union covering every kind of streamed event a host renders.
 * Production yields these from Claude SDK messages; the TUI playground yields
 * them from canned scripts.
 */
