...
/** The run spinner a harness drives. In the agent it is a thin emitter. */
...
/**
 * Context for an auth-error report so the host can pick the right copy.
 *
...
export type AgentProgress =
  ...
  /** The handoff document from `publish_handoff` (`WizardUI.setHandoffText`). */
