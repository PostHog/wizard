...
tasks, in this order:
  ...
  4. Enable products (replay, error tracking, support)
  5. Enable signal sources
  6. Offer issue-tracker integrations
  7. Configure the scout troop
...
STEP 4 — Enable products. (skill: "Enable products")
...
STEP 7 — Configure the scout troop. (skill: "Scouts")
