...
import { AgentOutputSignals } from '@agent/progress/output-signals';
import { RESUME_INSTRUCTION } from '@agent/progress/signals';
...
vi.mock('@utils/debug');
vi.mock('@agent/security/skill-preflight', () => ({
