 ...
 * injected answerer. The legacy adapter in `src/cli/runners/run-program-agent.ts`
...
// The outro contract is shared: hosts and shared exit code render it too.
export { OutroKind, type OutroData } from '@shared/run/outro';
...
export type { SpinnerHandle } from '@shared/run/spinner';
