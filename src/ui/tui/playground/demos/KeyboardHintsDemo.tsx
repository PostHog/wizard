...
const STEP_LABELS: Record<DemoStep, string> = {
  ...
  [DemoStep.MultiSelect]:
    'Multi Select — hints: ↑↓ navigate, space/enter select, arrow to Confirm + enter to submit',
  [DemoStep.GroupedSelect]:
    'Grouped Select — hints: ↑↓ navigate, space/enter select, a toggle all, arrow to Confirm + enter to submit',
