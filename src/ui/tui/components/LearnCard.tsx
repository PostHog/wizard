/**
 * LearnCard — Animated content slideshow in the left "Learn" pane of RunScreen.
 *
 * Generic: takes a ContentBlock[] script from the caller. Knows nothing
 * about PostHog, frameworks, or migrations. The script lives in the
 * workflow that owns the narrative (see workflows/<name>/learn-content/).
 */
...
interface LearnCardProps {
  store?: WizardStore;
  /** The script to play. Workflow-owned; see workflows/<name>/learn-content/. */
  blocks: ContentBlock[];
  onComplete?: () => void;
}
