...
import { VUE_AGENT_CONFIG } from '@programs/frameworks/vue/vue-wizard-agent';
...
import { TANSTACK_START_AGENT_CONFIG } from '@programs/frameworks/tanstack-start/tanstack-start-wizard-agent';
import { REACT_NATIVE_AGENT_CONFIG } from '@programs/frameworks/react-native/react-native-wizard-agent';
import { ANGULAR_AGENT_CONFIG } from '@programs/frameworks/angular/angular-wizard-agent';
...
import { SVELTEKIT_AGENT_CONFIG } from '@programs/frameworks/svelte/svelte-wizard-agent';
import { FLUTTER_AGENT_CONFIG } from '@programs/frameworks/flutter/flutter-wizard-agent';
import { SWIFT_AGENT_CONFIG } from '@programs/frameworks/swift/swift-wizard-agent';
import { KMP_AGENT_CONFIG } from '@programs/frameworks/kmp/kmp-wizard-agent';
import { ANDROID_AGENT_CONFIG } from '@programs/frameworks/android/android-wizard-agent';
import { RAILS_AGENT_CONFIG } from '@programs/frameworks/rails/rails-wizard-agent';
import { ELIXIR_AGENT_CONFIG } from '@programs/frameworks/elixir/elixir-wizard-agent';
import { GO_AGENT_CONFIG } from '@programs/frameworks/go/go-wizard-agent';
import { JAVA_AGENT_CONFIG } from '@programs/frameworks/java/java-wizard-agent';
import { RUST_AGENT_CONFIG } from '@programs/frameworks/rust/rust-wizard-agent';
import { PYTHON_AGENT_CONFIG } from '@programs/frameworks/python/python-wizard-agent';
import { RUBY_AGENT_CONFIG } from '@programs/frameworks/ruby/ruby-wizard-agent';
import { JAVASCRIPT_NODE_AGENT_CONFIG } from '@programs/frameworks/javascript-node/javascript-node-wizard-agent';
import { JAVASCRIPT_WEB_AGENT_CONFIG } from '@programs/frameworks/javascript-web/javascript-web-wizard-agent';
