...
import { FLUTTER_AGENT_CONFIG } from './flutter/flutter-wizard-agent';
import { SWIFT_AGENT_CONFIG } from './swift/swift-wizard-agent';
import { KMP_AGENT_CONFIG } from './kmp/kmp-wizard-agent';
import { ANDROID_AGENT_CONFIG } from './android/android-wizard-agent';
import { RAILS_AGENT_CONFIG } from './rails/rails-wizard-agent';
import { ELIXIR_AGENT_CONFIG } from './elixir/elixir-wizard-agent';
import { GO_AGENT_CONFIG } from './go/go-wizard-agent';
import { JAVA_AGENT_CONFIG } from './java/java-wizard-agent';
import { RUST_AGENT_CONFIG } from './rust/rust-wizard-agent';
