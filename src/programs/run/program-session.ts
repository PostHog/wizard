...
import { POSTHOG_LOCAL_URL, resolveLocalDev } from '@shared/config/local-dev';
import { ScanConsent, type DiscoveredFeature } from '@shared/run/scan-consent';
import type {
  AdditionalFeature,
  Harness,
  Integration,
...
import type { ApiUser, ApiProject, Credentials } from '@shared/posthog/api';
