...
import { MATRIX_FADE, Panel, type VisualProps } from './panel.js';
import { createGrid, plot, writeText, type Grid } from './grid.js';
import { VISUALIZER_PALETTE } from './palette.js';
