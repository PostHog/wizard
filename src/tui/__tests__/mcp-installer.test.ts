...
import * as mcpModuleReal from '@store/services/steps/add-mcp-server-to-clients';
...
vi.mock('@store/services/steps/add-mcp-server-to-clients', () => ({
...
vi.mock('@store/services/steps/add-mcp-server-to-clients/defaults', () => ({
