...
import { regionOption } from './headless-mode';
import { initLocalDev, localMcpSkillsNotice } from '@shared/config/local-dev';
...
export const GLOBAL_OPTIONS = {
  ...
  // commands declare it through `headlessOption` in @cli/headless-mode.
  'base-url': {
    describe:
...
export class Wizard {
  ...
  private constructor() {
    ...
    // @cli/headless-mode). CI needs `region` globally because the workbench
