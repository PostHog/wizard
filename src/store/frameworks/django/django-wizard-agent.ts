...
import { PYTHON_PACKAGE_INSTALLATION } from '../../framework-config.js';
import { detectPythonPackageManagers } from '../../detection/package-manager.js';
import { Integration } from '../../shared/constants.js';
import { boundedGlob, readProjectFile } from '../../shared/bounded-fs.js';
