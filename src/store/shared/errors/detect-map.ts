...
import type { RevenueDetectError } from '../../programs/revenue-analytics/detect.js';
import type { SelfDrivingDetectError } from '../../programs/self-driving/detect.js';
import type { SourceMapsDetectError } from '../../programs/error-tracking-upload-source-maps/detect.js';
import type { WarehouseDetectError } from '../../programs/warehouse-source/detect.js';
import type { WebAnalyticsDetectError } from '../../programs/web-analytics-doctor/detect.js';
