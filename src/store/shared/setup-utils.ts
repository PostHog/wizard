...
import type { CloudRegion, WizardRunOptions } from './types.js';
import { getDeclaredVersion } from './package-json.js';
import { DUMMY_PROJECT_API_KEY, ISSUES_URL } from './constants.js';
import {
  getOAuthScopesForProgram,
  getProvisioningScopesForProgram,
} from '../services/oauth/program-scopes.js';
...
import { resolveGrantedProject } from './project-resolution.js';
import {
