...
import { resolveProjectDir } from '../../detection/agentic.js';
import { RunPhase, type WizardSession } from '../../session/wizard-session.js';
import { HEALTH_CHECK_STEP } from '../shared/health-check-step.js';
import { integrationRunStep } from '../posthog-integration/index.js';
import {
