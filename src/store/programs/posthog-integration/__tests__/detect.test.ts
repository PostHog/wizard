...
vi.mock(
  '../../../services/warehouse-sources/detect.js',
  async (importOriginal) => {
    const actual = await importOriginal<
      typeof import('../../../services/warehouse-sources/detect.js')
    >();
    return {
      ...actual,
...
import { detectWarehouseSources } from '../../../services/warehouse-sources/detect.js';
import {
  detectPostHogIntegration,
  maybeStampAiSdkDetected,
  reportWarehouseSourcesDetected,
} from '../detect.js';
import { posthogIntegrationConfig } from '../index.js';
import { DETECTED_WAREHOUSE_SOURCES_KEY } from '../../warehouse-source/detect.js';
