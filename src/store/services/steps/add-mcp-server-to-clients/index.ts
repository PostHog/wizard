...
import { CursorMCPClient } from './clients/cursor.js';
import { ClaudeCodeMCPClient } from './clients/claude-code.js';
import { ClaudeWebMCPClient } from './clients/claude-web.js';
import { VisualStudioCodeClient } from './clients/visual-studio-code.js';
import { ZedClient } from './clients/zed.js';
import { CodexMCPClient } from './clients/codex.js';
import { OpenCodeMCPClient } from './clients/opencode.js';
import { ALL_FEATURE_VALUES } from './defaults.js';
import { debug } from '../../../shared/debug.js';
import { isPluginCapable, PluginCapable } from './plugin-client.js';
import {
  McpClientStatus,
  namesWithStatus,
  toClientResult,
