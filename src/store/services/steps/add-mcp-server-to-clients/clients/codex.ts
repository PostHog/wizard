...
import { LoginCapable } from '../login-client.js';
import { DefaultMCPClient } from '../MCPClient.js';
import { DefaultMCPClientConfig, buildMCPUrl } from '../defaults.js';
import { PluginCapable, PluginInstallResult } from '../plugin-client.js';
import { redactSecrets, type InstallResult } from '../results.js';
