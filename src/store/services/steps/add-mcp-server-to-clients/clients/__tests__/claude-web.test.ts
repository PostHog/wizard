import { ClaudeWebMCPClient } from '../claude-web.js';
import { isBrowserFinishable } from '../../browser-client.js';
import { openTrackedLink } from '../../../../../shared/links.js';

vi.mock('../../../../../shared/links.js', () => ({
