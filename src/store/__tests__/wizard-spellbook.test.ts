...
import { writeWizardSpellbook } from '../wizard-spellbook.js';
import { downloadSkill, fetchSkillMenu } from '../tools/tools.js';

vi.mock('../tools/tools.js', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../tools/tools.js')>()),
