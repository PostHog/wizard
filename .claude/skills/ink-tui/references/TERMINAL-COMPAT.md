...
[terminal.ts](../../../../src/tui/terminal.ts) owns the alternate screen buffer
and black background shared with the playground. Reuse this lifecycle.
...
[useStdoutDimensions](../../../../src/tui/hooks/useStdoutDimensions.ts)
subscribes to resize events and supplies fallback dimensions when a stream has
none.

[ScreenContainer](../../../../src/tui/primitives/ScreenContainer.tsx) centers
and caps content width. On a real TTY, it shows
[ViewportTooSmall](../../../../src/tui/primitives/ViewportTooSmall.tsx) below
...
Use
[ViewportGuardDemo](../../../../src/tui/playground/demos/ViewportGuardDemo.tsx)
...
[default integration command](../../../../src/cli/commands/basic-integration/index.ts)
...
[Environment detection](../../../../src/store/shared/environment.ts) checks
...
is defined in [headless-mode.ts](../../../../src/store/shared/headless-mode.ts);
keep its hidden flag out of user-facing guidance. Other commands can have their
own fallback, such as
...
[LoggingUI](../../../../src/tui/console/logging-ui.ts) and the command/runner
contract, including explicit handling of interactions that cannot be answered.
